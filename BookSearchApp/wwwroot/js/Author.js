        ...
        success: function (data) {
            ...
            if (author) {
                for (var i in author) {
                    ...
                    html += "<div class='img-container'><img class=\"card-img\" src=" + author[i].imageLink + "></div>";
                    html += '<strong> <h4>' + author[i].Full_name + '</h4> </strong>';
                    html += '<strong> <h2>' + author[i].Pseudonym + '</h4> </strong>';
                    html += '<p> Дата рождения' + author[i].Date_of_Birth + '</p>';
