    ...
    public static class DbInitializer
    {
        public static void Initialize(BookSearchContext context)
        {
            ...
            var comments = new Comment[]
                {
                     new Comment { BookID = 1, Title = "Кто слишком часто оглядывается назад, легко может споткнуться и упасть", User = new User { UserId = "1", Name = "Муркин Федя", Login = "User2"},
